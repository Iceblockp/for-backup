...
const EditDrawer = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const res = await courseApi.put( "/courses/" + id,
  ...
  return (
    <div
      ...
      } fixed shadow-sm top-0 right-0 z-40 h-screen p-4 overflow-y-auto transition-transform bg-white w-80 dark:bg-gray-800`}
      tabIndex={-1}
    ...
    dark:focus:border-blue-500"
        ...
        <div className="flex justify-between items-center mt-5 ">
          ...
          <button
            disabled={isLoading}
            type="submit"
            data-drawer-target="edit-drawer"
            data-drawer-show="edit-drawer"
            data-drawer-placement="right"
            aria-controls="edit-drawer"
            className="text-white group disabled:opacity-70 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
          >
            <span className=" inline group-disabled:hidden ">Update</span>
            <span className=" hidden group-disabled:flex">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
