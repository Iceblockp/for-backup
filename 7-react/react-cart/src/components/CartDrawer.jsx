...
const CartDrawer = () => {
  ...
  //     observer.observe(mainDivRef.current, { attributes: true, childList: true, subtree: true })
  //   }
  ...
  return (
    ...
    >
      ...
      <div className="cart-body flex-grow flex flex-col overflow-scroll p-5">
       {carts.length == 0 && <div className="cart-empty-stage m-auto  text-center w-3/4">
          <img src="https://mms-cart.netlify.app/assets/empty-cart-587700a3.svg" />
          <p className="font-heading">There is no item in cart</p>
        </div>}
         {carts.length > 0 && carts.map(cart => <Cart key={cart.product_id} cart={cart} />)}
