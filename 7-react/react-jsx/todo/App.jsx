...
const App = () => {
  ...
  const [tasks, setTask] = useState([
    ...
    { id: 2, job: "Read a book", isDone: false },
    { id: 3, job: "Go for a run", isDone: false },
    { id: 4, job: "Write a blog post", isDone: false },
    { id: 5, job: "Buy groceries", isDone: false },
  ]);
  ...
  return (
    <div className="w-[400px] mx-auto mt-20">
      ...
      <Status tasks={tasks} />
      <ListGroup updateTaskJob={updateTaskJob} doneAllTask={doneAllTask} tasks={tasks} deleteTask={deleteTask} doneTask={doneTask} />
      {/* <Counter /> */}
      {/* <Input /> */}
      {/* <Checker/> */}
      {/* <AccordionGroup/> */}
