...
const fruits = [ "apple", "banana","ဟဲလို", "mango","lime", "lemon", "orange"];
const points = [34, 15, 2, 52, 19, 56, 30,57];
const product = [
    {
        "id": 1,
...
// console.log(points.map((el) => console.log(el)));
...
// console.log(points.filter(point => point < 50));
...
// console.table(product.filter(el => el.title.search("Gaming") != -1));
...
// console.log(points.map((el) => el*2));
// console.table(product);
...
// const scope = [7,10,5,2,6];
// console.table(product.filter(el => scope.includes(el.id)));


// console.log(points);
// console.log(points.find(el => el==52));
// console.log(points.findIndex(el => el ==30));

// console.table(product.find(el => el.id ==7));
...
// console.log(run.x().y().z().x());


// အသီးတွေထဲက စကားလုံးး ၅ လုံး ပါတဲ့အသီးတေါက်ု console mhar list လုပ်ပြီးထုတ်ပြပါ
