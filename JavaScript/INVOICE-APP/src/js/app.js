...
<td class="px-6 py-4 text-end record-price">
    ${productPrice}
</td>
<td class="px-6 py-4 text-end">
<button class="q-sub bg-blue-100  text-blue-600 p-1 rounded opacity-0 group-hover:opacity-100 -translate-x-6 group-hover:translate-x-0 duration-200 pointer-events-none group-hover:pointer-events-auto">
...
<path stroke-linecap="round" stroke-linejoin="round" d="M19.5 12h-15" />
   ...
   <span class=" w-5 inline-block record-q">${quantity}</span>
<button class="q-add bg-blue-100  text-blue-600 p-1 rounded opacity-0 group-hover:opacity-100 translate-x-6 group-hover:translate-x-0 duration-200 pointer-events-none group-hover:pointer-events-auto">
   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-3 h-3 pointer-events-none">
...
<td class="px-6 py-4 text-end relative">
    ...
    <button  class="record-del bg-blue-100 rounded-lg p-2 pointer-events-none group-hover:pointer-events-auto active:scale-75 opacity-0 group-hover:opacity-100 group-hover:left-3/4 duration-300 left-full absolute">
