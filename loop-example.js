...
// console.log(product[4].rating.count);
...
// console.log(8%2 ? "odd" : "even");
// console.log(7%2 ? "odd" : "even");
...
//     return result;
// }
// console.log(modifyArray(points));
...
// console.log(rect(5,9));

// ကြားကွက် အိမ်စာ

// const game = function(col,row){
//     let resultsquare = "";
//     for(let i=1; i<=row ; i++){
...
// row and col 
// let String = "";
// const pointGame = function(row , col){
//     for (let i=1; i<=row; i++){
...
//     return String;
// }
// console.log(pointGame(5,5));


// start one col and row and col increase
// let String = "";
// const pointGame = function(row){
//     for (let i=1; i<=row; i++){
...
//     return String;
// }
// console.log(pointGame(5));


// third
// const pointGame = function(n){
//     let String = "";
//     for (let x=1; x<=n; x++){
...
// }
// console.log(pointGame(5));
// console.log(pointGame(12));



//fourth
// const pointGame = function(z){
//     let String = "";
//         for (let x=1; x<=z; x++){
//         for(let y=z ;y>=1; y--){
//            if(x>=y ){
...
// }
// console.log(pointGame(5));
// console.log(pointGame(10));

//sharp edge square


// const topEdge = function(x){
//     let String = "";
//     for(let i=1 ; i<=x; i++){
//         for(let j=x; j>=(-x); j--){
//             if(j==i || j==(-i+2) || (i==x && j>=(-x+2))){
//                 String +="* ";
//             }else{
//                 String += "  ";
//             }
...
// console.log(topEdge(5));
// console.log(topEdge(10));
...
// console.log(student1Mark[2].mark);

// console.log(student1Mark);
// let totm = 0;
// for(let i=0 ; i< student1Mark.length; i++){
//     totm+=student1Mark[i].mark
// }
// console.log(totm);
...
// console.log(allStudentsMark[2].marks[5].mark);
